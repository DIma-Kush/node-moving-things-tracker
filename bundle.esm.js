...
ItemTracked$1.ItemTracked = function (properties, frameNb, unMatchedFramesTolerance, fastDelete) {
  ...
  (function (e, t) {
    ...
    function n(e, n, i) {
      function o(e, n, r) {
        ...
        a = new t(e[u], s, r);
        a.left = o(e.slice(0, u), n + 1, a);
        a.right = o(e.slice(u + 1), n + 1, a);
        return a;
      }
      ...
      var s = this;
      if (!Array.isArray(e)) u(e);else this.root = o(e, 0, null);

      this.toJSON = function (e) {
        if (!e) e = this.root;
        var n = new t(e.obj, e.dimension, null);
        if (e.left) n.left = s.toJSON(e.left);
        if (e.right) n.right = s.toJSON(e.right);
        return n;
      };
      ...
      this.insert = function (e) {
        ...
        var r = n(this.root, null),
            s,
            o;

        if (r === null) {
          this.root = new t(e, 0, null);
          return;
        }

        s = new t(e, (r.dimension + 1) % i.length, r);
        o = i[r.dimension];
      ...
      this.remove = function (e) {
        ...
        function r(e) {
          ...
          if (e.left === null && e.right === null) {
            ...
            o = i[e.parent.dimension];

            if (e.obj[o] < e.parent.obj[o]) {
              e.parent.left = null;
            } else {
              e.parent.right = null;
            }
          ...
          if (e.left !== null) {
            t = u(e.left, e.dimension);
          } else {
            t = a(e.right, e.dimension);
          }
      ...
      this.nearest = function (e, t, o) {
        function l(r) {
          ...
          if (f.size() < t || Math.abs(c) < f.peek()[1]) {
            if (s === r.left) {
              h = r.right;
            } else {
              h = r.left;
        ...
        for (u = 0; u < t; u += 1) {
          if (f.content[u][0]) {
            a.push([f.content[u][0].obj, f.content[u][1]]);
          }
        }
      ...
      this.balanceFactor = function () {
        function e(t) {
          ...
          return Math.max(e(t.left), e(t.right)) + 1;
        }
        ...
        function t(e) {
          ...
          return t(e.left) + t(e.right) + 1;
        }

        return e(s.root) / (Math.log(t(s.root)) / Math.log(2));
      };
    }
    ...
    r.prototype = {
      ...
      remove: function remove(e) {
        ...
        for (var n = 0; n < t; n++) {
          if (this.content[n] == e) {
            ...
            if (n != t - 1) {
              this.content[n] = r;
              if (this.scoreFunction(r) < this.scoreFunction(e)) this.bubbleUp(n);else this.sinkDown(n);
            }
      ...
      bubbleUp: function bubbleUp(e) {
        ...
        while (e > 0) {
          ...
          if (this.scoreFunction(t) < this.scoreFunction(r)) {
            this.content[n] = t;
            this.content[e] = r;
            e = n;
          } else {
        ...
        while (true) {
          ...
          if (s < t) {
            var u = this.content[s],
                a = this.scoreFunction(u);
            if (a < r) o = s;
          }

          if (i < t) {
            var f = this.content[i],
                l = this.scoreFunction(f);
...
export { computeDistance, tracker as default, disableKeepInMemory, enableKeepInMemory, getAllTrackedItems, getJSONDebugOfTrackedItems, getJSONOfAllTrackedItems, getJSONOfTrackedItems, getTrackedItemsInMOTFormat, reset, setParams, updateTrackedItemsWithNewFrame };
