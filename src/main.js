...
var isInsideSomeAreas = require('./tracker/utils').isInsideSomeAreas;
var ignoreObjectsNotToDetect = require('./tracker/utils').ignoreObjectsNotToDetect;
var isDetectionTooLarge = require('./tracker/utils').isDetectionTooLarge;

/*
    NOTE: this file is a big mess with piled up code from different use cases
    Should be reworked to be much simpler
    If you are looking for the tracker, look start.js file
    this main.js is just giving different way to operate start.js
*/
